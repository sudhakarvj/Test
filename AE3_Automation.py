...
height:1.5em;
    ...
    if xhtml_file:
        for filename in xhtml_file:
            ...
            xhtml_cnt = re.sub(r'<body(?: [^>]*)?>', lambda m: re.sub(r' epub:type="[^"]*"', r'', m.group(), 0, re.I | re.S), xhtml_cnt, 1, re.I | re.S)
            ...
            if re.search(r'ch(apter)?\d+\.xhtml', filename, re.I | re.S):
                ...
                xhtml_cnt = re.sub(r'<p class="H1[^"]*">((?:(?!</p>).)*)</p>', r'<section epub:type="title">\n<header>\n<h2 epub:type="title" class="H1">\g<1></h2>\n</header>', xhtml_cnt, 0, re.I | re.S)
                xhtml_cnt = re.sub(r'<p class="H2[^"]*">((?:(?!</p>).)*)</p>', r'<section epub:type="title">\n<header>\n<h3 epub:type="title" class="H1">\g<1></h3>\n</header>', xhtml_cnt, 0, re.I | re.S)
                xhtml_cnt = re.sub(r'<p class="H3[^"]*">((?:(?!</p>).)*)</p>', r'<section epub:type="title">\n<header>\n<h4 epub:type="title" class="H1">\g<1></h4>\n</header>', xhtml_cnt, 0, re.I | re.S)
                xhtml_cnt = re.sub(r'(<section epub:type="title">\s*<header>\s*<h2(?: [^>]*)?>)', r'</section>\n\g<1>', xhtml_cnt, 0, re.I | re.S)
                xhtml_cnt = re.sub(r'(<section epub:type="title">\s*<header>\s*<h3(?: [^>]*)?>)', r'</section>\n\g<1>', xhtml_cnt, 0, re.I | re.S)
                xhtml_cnt = re.sub(r'(<section epub:type="title">\s*<header>\s*<h4(?: [^>]*)?>)', r'</section>\n\g<1>', xhtml_cnt, 0, re.I | re.S)
            ...
            if re.search(r'title\.xhtml', filename, re.I | re.S):
                ...
                xhtml_cnt = re.sub(r'(<h1(?: [^>]*)?>(?:(?!</h1>).)*</h1>\s*)<p(?: [^>]*)?>((?:(?!</p>).)*</p>)', r'\g<1><p class="subtitle" epub:type="subtitle" role="doc-subtitle">\g<2>', xhtml_cnt, 1, re.I | re.S)
